...
public class CustomercenterController {
	...
	public ModelAndView selectQnaList(@RequestParam(value = "cPage", defaultValue = "1") int cPage, ModelAndView mav) {
	...
	public ModelAndView seachKeyword(ModelAndView mav, @RequestParam(name = "searchkeyword") String searchkeyword,
	...
	public ModelAndView mainTutorial(ModelAndView mav, @RequestParam(value = "cPage", defaultValue = "1") int cPage) {
		int numPerPage = 5;
		// 업무로직
		// 1.게시글 리스트(페이징적용)
	...
	public ModelAndView buyTutorial(ModelAndView mav, @RequestParam(value = "cPage", defaultValue = "1") int cPage) {
		int numPerPage = 5;
		// 업무로직
		// 1.게시글 리스트(페이징적용)
	...
	public ModelAndView sellTutorial(ModelAndView mav, @RequestParam(value = "cPage", defaultValue = "1") int cPage) {
		int numPerPage = 5;
		// 업무로직
		// 1.게시글 리스트(페이징적용)
	...
	public ModelAndView insertQna(Board board, @RequestParam(name = "catradio") String catradio, ModelAndView mav) {
	...
	public ModelAndView updateQna(Board board, ModelAndView mav,
			@RequestParam(name = "seq_board_no") int seq_board_no) {
	...
	public ModelAndView selectinquiryList(HttpSession session, ModelAndView mav) {
	...
	public ModelAndView insertInquiry(ModelAndView mav, @RequestParam(name = "selone") String selone,
			@RequestParam(name = "seltwo") String seltwo, @RequestParam(name = "incontent") String incontent,
	...
	public ModelAndView insertAnswer(ModelAndView mav, @RequestParam(name = "question_answer") String question_answer,
			@RequestParam(name = "seq_member_no") int seq_member_no,
