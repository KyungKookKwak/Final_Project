...
public class MemberController {
	...
	public void interestUpdate(@RequestParam(value = "memberNo") String memberNo,
			@RequestParam(value = "interest") String interest, HttpServletResponse response)
